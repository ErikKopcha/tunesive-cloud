...
const TopChartCard = ({ song, index, isPlaying, handlePlayClick, handlePauseClick, activeSong }) => (
  <div className="w-full flex flex-row items-center hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2">
    <h3 className="font-bold text-base text-white mr-3">{++index}</h3>
    ...
    <div className="flex-1 flex flex-row justify-between items-center">
      ...
      <div className="flex flex-1 flex-col justify-center mx-3">
        ...
        <Link to={`/atrists/${song?.artists[0]?.adamid}`}>
...
const TopPlay = () => {
  ...
  const { data = savedMusicData } = {}; //useGetTopChartsQuery();
